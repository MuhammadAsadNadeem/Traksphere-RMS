...
export class Sync1737500729067 implements MigrationInterface {
    name = 'Sync1737500729067'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "route" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "routeName" character varying NOT NULL, "routeNumber" character varying NOT NULL, "vehicleNumber" character varying NOT NULL, "busStopIds" text array NOT NULL, "driverId" uuid, CONSTRAINT "PK_08affcd076e46415e5821acf52d" PRIMARY KEY ("id"))`);
